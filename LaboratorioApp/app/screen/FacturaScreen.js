...
nuevoDetalle = {
  ...
  // Obtener todas las órdenes únicas de los detalles
  const ordenesUnicas = [...new Set(facturas.map(detalle => detalle.idorden))];
    const factura = {
    ...
    fetch(URL_FACTURA, {
      ...
      .then((data) => {
        ...
        // Actualizar el estado de TODAS las órdenes incluidas en la factura
      ...
      // También actualizar todas las órdenes en caso de otros tipos de respuesta
      ordenesUnicas.forEach(idOrden => {
        if (idOrden) {
          actualizarEstadoOrden(idOrden);
        }
